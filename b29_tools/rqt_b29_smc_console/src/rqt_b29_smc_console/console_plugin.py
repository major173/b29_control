...
_VALIDATION_TRACE_GROUPS = (
    ...
    ('Crossing', (
        ...
        'disconnect_check_displacement', 'to_check_joint_pos', 'succeed_disconnect_cable_threshold',
        ...
        'close_gripper_retry_limit', 'disconnect_cable_retry_limit', 'regrip_retry_limit',
        ...
        'remote_control_input_valid', 'remote_control_sample_sequence',
        'remote_control_complete', 'remote_control_completion_rising_edge',
    )),
    ('Command & Safety', (
        'command_reason', 'drive_mode', 'stop_all', 'freeze_joints',
