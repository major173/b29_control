...
const char* disconnectStepExpectedCondition(DisconnectCableStep step)
{
  switch (step)
  {
    ...
    case DisconnectCableStep::Step7CheckIfCableDisconnected:
      return "three_joint_velocity_settle";
    case DisconnectCableStep::Failed:
                                             ...
                                             const ControllerTraceState& controller_state)
{
  ...
  trace.disconnect_max_abs_pose_joint_velocity = controller_state.disconnect_max_abs_pose_joint_velocity;
  trace.disconnect_settle_velocity_threshold = controller_state.disconnect_settle_velocity_threshold;
  trace.disconnect_velocity_within_threshold = controller_state.disconnect_velocity_within_threshold;
  trace.disconnect_velocity_stable_elapsed_sec = controller_state.disconnect_velocity_stable_elapsed_sec;
  trace.disconnect_settle_duration = controller_state.disconnect_settle_duration;
  ...
  trace.obstacle_crossing_trigger = controller_state.obstacle_crossing_trigger;
  trace.obstacle_trigger_rising_edge = controller_state.obstacle_trigger_rising_edge;
  trace.obstacle_trigger_falling_edge = controller_state.obstacle_trigger_falling_edge;
  trace.obstacle_trigger_rising_edge_sequence = controller_state.obstacle_trigger_rising_edge_sequence;
  trace.obstacle_trigger_falling_edge_sequence = controller_state.obstacle_trigger_falling_edge_sequence;
  ...
  trace.debug_obstacle_crossing_trigger = controller_state.debug_obstacle_crossing_trigger;
  trace.temporary_allow_start_without_grip_confirmed =
      controller_state.temporary_allow_start_without_grip_confirmed;
  ...
  trace.cruise_drive_request = cruiseDriveRequestName(controller_state.cruise_drive_request_raw);
  trace.cruise_drive_request_valid = controller_state.cruise_drive_request_valid;
  trace.auto_start = controller_state.auto_start;
  trace.manual_reset = controller_state.manual_reset;
  trace.auto_start_rising_edge_sequence = controller_state.auto_start_rising_edge_sequence;
  trace.manual_reset_rising_edge_sequence = controller_state.manual_reset_rising_edge_sequence;
  return trace;
}
}  // namespace b29_smc_auto_controller
